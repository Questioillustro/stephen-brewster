  ...
  return (
    <div css={SummaryStyle.root}>
      <Typography variant={'body1'}>
        ...
        continued with it through my Senior year where I spent every study hall in the computer lab
        working on my very own versions of Tetris and Pacman for extra credit. Over twenty years
        later I am still surprised and amazed by the ways that my profession is evolving and
